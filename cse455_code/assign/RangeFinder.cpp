...
int main(int argc, char* argv[])
{
    ...
    double expObjLOC = 24.62;
    if(argc == 3)
	expObjLOC = (double)arg[2];
    ...
    cout << "B0: " << B0 << "\n";
    cout << "B1: " << B1 << "\n";
    double range = RF.calculateRange(0.70);
    if( range > 0)
    {
	cout << range << endl;
    	cout << "For and 70 percent prediction range we get:\n";
